namespace GameApplicationTools.UI
{
    ...
    /// </summary>
    public class GameConsole : IGameComponent, IUpdateable, IDrawable
    {
        /// <summary>
        ...
        class CommandSuggestionProvider : ISuggestionProvider
        {
            public IList<string> GetSuggestions(string command, int argumentIndex, string argument, IList<string> previousArguments)
            {
                ...
                var list = GameConsole.Instance.commands.Keys.Where(c => c.StartsWith(argument ?? string.Empty)).ToList();
        ...
        class SelectionMemberSuggestionProvider : ISuggestionProvider
        {
            ...
            public IList<string> GetSuggestions(string command, int argumentIndex, string argument, IList<string> previousArguments)
            {
                var types = GameConsole.Instance.FindCommonBaseTypesOfSelection();
